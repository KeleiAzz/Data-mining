...
par(new=TRUE)
plot(seq(100,900,100),ada.res,ylim=yrange,col='green',type='o',pch=4)
par(new=TRUE)
plot(seq(100,900,100),adac.res,ylim=yrange,col='gray',type='o',pch=4)
